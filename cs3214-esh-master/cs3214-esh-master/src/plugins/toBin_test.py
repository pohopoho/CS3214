...
#Tests toBin with invalid input
c.sendline("toBin ")
assert c.expect("You must enter an integer to be converted to binary") == 0, "toBin did not produce the right answer becuase the input was invalid"
